...
import { FileIcon, ExternalLink, ImageIcon } from "lucide-react";
  ...
  return (
    <>
      ...
      <Dialog open={!!previewUrl} onOpenChange={() => setPreviewUrl(null)}>
        <DialogContent className="max-w-5xl p-2 sm:p-6 max-h-[90vh] overflow-hidden">
            ...
            <div className="flex flex-col items-center">
              {isImage ? (
                <Image
                  ...
                  width={1400}
                  height={900}
                  className="max-h-[75vh] w-auto rounded-lg shadow-xl"
