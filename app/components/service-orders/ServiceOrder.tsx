...
import { colors, Order, Request, ServiceOrderProps } from "@/lib/interfaces";
...
export default function ServiceOrder({
  ...
  // Stats calculation based on Order interface
  const stats = [
    {
      title: "Total Orders",
      value: orders.length,
  ...
  // Define columns for Orders using Order interface
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] p-6 md:p-8">
      ...
      {/* Approved Service Requests Dialog */}
      <Dialog
